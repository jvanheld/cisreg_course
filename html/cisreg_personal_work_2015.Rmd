...
Chaque binôme identifiera, sur le site du projet Encode [https://www.encodeproject.org/](https://www.encodeproject.org/), un facteur transcriptionnel d'intérêt. Le but du projet sera de mobiliser les différents outils abordés durant les cours, afin d'extraire le plus d'information possible à partir des pics de liaison de ce facteur transcriptionnel dans un ou plusieurs types cellulaires. 
...
a. Faites tourner une ou plusieurs approches de découverte de motifs (par exemple RSAT peak-motifs, MEME-chip) sur les pics. 
