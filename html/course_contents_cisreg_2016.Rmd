...
|------------|-------|--------------------------------|---------|----------|--------|
| Mon 17/10 | 09:00 | 10:30 | Characterizing and representing TF-DNA interactions <br>(from sites to motifs) | JvH | [[RSAT](http://rsat.eu/)]<br>[[tutorial *from sites to motifs*](../from_sites_to_matrices/from_sites_to_matrices.html)] |
