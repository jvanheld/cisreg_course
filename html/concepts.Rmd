...
### IUPAC code for ambiguous nucleotides and degenerate consensus
...
The IUPAC code can be used to specify the **degenerate consensus** of a transcription factor, i.e. a consensus summarizing the common residues found in a collection of aligned binding sites. For example, the consensus CACGTK means "CACTG" followed by either T or G.
