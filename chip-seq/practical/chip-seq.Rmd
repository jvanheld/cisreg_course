...
> - In the left menu, select **Get Data &gt; Upload File**. set File format as **fastqsanger** and set genome to **hg19**. Select **Paste/Fetch data** and copy and paste the URL above in the **text area**. 
