...
4. Use the RSAT tool ***matrix distribution*** to compute the theoretical distribution of probability for your motif.

### Score distribution of the bona fide binding sites
...
8. Write a short report summarizing the result for your transcription factor. In particular, 
