...
4. Compute the same statistics with a randomized version of your matrix, generated with **permute-matrix**.

5. How many binding sites and target genes do you obtain when you scan the whole set of promoters with p-value thresholds of respectively 0.001 and 0.0001. 
...
Summarize the number of predicted binding sites in all the conditions above. 
